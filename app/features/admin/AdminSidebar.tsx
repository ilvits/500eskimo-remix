...
export function AdminSidebar() {
  ...
  return (
    <div className='ml-12 border-r h-screen'>
      <nav id='sidebar' className='w-[188px] pr-4 flex flex-col space-y-1'>
        <NavLink to='./dashboard' className='flex items-center space-x-2.5 px-2 py-2.5 rounded-lg active:bg-[#FFFBF2]'>
        ...
        <NavLink to='./orders' className='flex items-center justify-between px-2 py-2.5 rounded-lg active:bg-[#FFFBF2]'>
